...
import cv2
import os
from src.lib.SIFT import SiftMatching
from src.lib.RANSAC import RANSAC
from src.lib.Optimize import OptimizeFunction
from src.lib.ImageUtils import fit_image_in_target_space
from src.lib.Optimize import fun_LM_homography, jac_LM_homography



class GenerateMosaic:

    def __init__(self, parent_folder, img_name_list, result_folder = ""):
        self.img_all = {}
    ...
    def mosaic(self, nfeatures=2000, gamma=0.6, resize=True, distortion=True, rotate90=False):
        ...
        return self.stitch(H_all, siftmatch_obj.result_fldr)
